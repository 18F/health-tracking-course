...
This is an overview, and provides context. We don't anticipate that you will need to make a lot of notes here, but you might jot down words that sound like good vocabulary to have, and perhaps words/phrases/concepts that you might want to follow up on and ask questions about later.
...
This conversation is part of your preparation for coming together as a larger group to discuss the notion of FOSS, government contracting, and the work of SOs in managing The People's investment in software and IT.
## Keystones (15m, solo)
