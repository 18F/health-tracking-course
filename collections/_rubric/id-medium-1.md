...
{% include link id="kileynichols" text="Kiley Nichols provides a primer on DevOps" %} that answers some key questions and then summarizes the value of DevOps practices in five ways:
...
1. What are articles that describe best practices and tools that support the development and building of software systems?
