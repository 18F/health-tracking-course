...
4. **Debrief I**. {% include countdowntimer minutes=15 %} After 5 minutes, come back to your large group. As a group, discuss the roleplays. 
   * For the {{site.po}}s: What questions were particularly useful? What words/behaviors did you note from the state team members that were encouraging or inspired confidence? 
